<!doctype html>
<html lang="en" data-layout="vertical" data-topbar="dark" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none" data-preloader="disable" data-bs-theme="dark">
...
<head>
    ...
    <link href="{{ asset('assets/libs/fontawesome/css/all.min.css') }}" rel="stylesheet" type="text/css" />
...
<body>
    ...
    <livewire:admin.theme.customizer />
    ...
    <!-- Vector map-->
    <script data-navigate-once src="{{ asset('assets/libs/jsvectormap/jsvectormap.min.js') }}"></script>
    <script data-navigate-once src="{{ asset('assets/libs/jsvectormap/maps/world-merc.js') }}"></script>

    <!--Swiper slider js-->
    <script data-navigate-once src="{{ asset('assets/libs/swiper/swiper-bundle.min.js') }}"></script>
